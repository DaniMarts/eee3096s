...
# this function will not be used, as it clutters the terminal. The execution times will be logged into a csv file
...
def endlog(times):  # times is a list containing the elapsed times
    global start
    end = time()
    elapsed = end-start
